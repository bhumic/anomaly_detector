...
public class MappedPagesGraph {
	...
	//Object for storing (x,y) pair values
		...
		public MappedPagesGraph() {
			series = new XYSeries("Mapped pages");
			...
			mRenderer.setYTitle("MappedPages(MB)");
		...
		public void addNewPoint(String lineData, int second){
			double value = Double.parseDouble(lineData.split("\\s+")[2])/1000;
