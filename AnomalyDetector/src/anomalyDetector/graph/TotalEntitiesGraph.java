...
public class TotalEntitiesGraph {
	...
	//Object for storing (x,y) pair values
		...
		public TotalEntitiesGraph() {
			series = new XYSeries("Total Entities");
			...
			mRenderer.setYTitle("Total Entities");
		...
		public void addNewPoint(String lineData, int second){
			double value = Double.parseDouble(lineData.split("\\s+")[4]);
			...
			mRenderer.setYAxisMax(value + 100);
			mRenderer.setYAxisMin(value - 100);
		}
