...
public class ReceivedPacketsGraph {
	...
	public ReceivedPacketsGraph() {
		series = new XYSeries("Received Packets");
		...
		mRenderer.setYTitle("Received Packets");
	...
	public void addNewPoint(String lineData, int second){
		double value = Double.parseDouble(lineData.split("\\s+")[9]);
